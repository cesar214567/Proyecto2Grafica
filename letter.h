...
public:
  ...
  void f(){
    ...
    {
      vertices.push_back({temp.first, {temp.second, 1.f}});
    }
  ...
  void setup(glm::mat4 _view, glm::mat4 _projection)
  {
    view = _view;
  ...
  void draw(float escala,float angulo_x,float angulo_y,float angulo_z)
  {
    ...
    glm::vec4 temp(vertices[0].first, vertices[0].second.first,vertices[0].second.second,1.f);
